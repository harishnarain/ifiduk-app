...
export const loginRequest = {
  scopes: ['openid', ...authApiConfig.b2cScopes],
};

/**
   * Scopes you add here will be used to request a token from Azure AD B2C to be used for
...
export const tokenRequest = {
  ...
  scopes: [...authApiConfig.b2cScopes],
